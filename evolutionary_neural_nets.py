# -*- coding: utf-8 -*-
"""Evolutionary Neural Nets.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16di7rihTbjqCxqWfzXgh8rzcVAl9sy8X
"""
...
available_neurons = ['position_x', 'position_y', 'h1', 'h2', 'h3', 'move_up', 'move_down', 'move_left', 'move_right']
...
def save_video(history, epoch_number):
    ...
    # for epoch_number, epoch_log in history.items():
    video = VideoWriter(f'./videos/generation{epoch_number}.avi', fourcc, float(FPS), (width, height))
